...
>
  <head>
    ...
    {{-- IjaboCropTool --}}
    <link rel="stylesheet" href="{{asset('asset')}}/ijaboCropTool/ijaboCropTool.min.css" />
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Cards -->
            <li class="menu-item">
                <a href="{{ route('admin.profile') }}" class="menu-link {{(request()->is('admin/profile*')) ? 'active' : ''}}">
                    <i class="menu-icon tf-icons bx bx-collection"></i>
                    <div data-i18n="Basic">Profile</div>
                </a>
            </li>
            <li class="menu-item">
                <a href="{{ route('admin.settings') }}" class="menu-link {{(request()->is('admin/settings*')) ? 'active' : ''}}">
                    <i class="menu-icon tf-icons bx bx-collection"></i>
    ...
    <script src="{{asset('asset')}}/ijaboCropTool/ijaboCropTool.min.js"></script>
